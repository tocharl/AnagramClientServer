...
import atl.server.g49582.anagram.business.AdminFacade;
...
import atl.server.g49582.anagram.model.converter.WordDtoConverter;
...
public class Model implements Facade {
    ...
    @Override
    public String getCurrentWord() throws ModelException {
        if (currentWord == null) {
            throw new ModelException("Aucun mot en jeu");
        }
        return currentWord.getScramble();
